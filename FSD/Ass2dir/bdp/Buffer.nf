...
THEORY ListInstanciatedParametersX IS
  List_Instanciated_Parameters(Machine(Buffer),Machine(Resp))==(?)
END
&
...
THEORY ListSetsX IS
  ...
  Context_List_Enumerated(Machine(Buffer))==(RESP);
  Context_List_Defered(Machine(Buffer))==(?);
  Context_List_Sets(Machine(Buffer))==(RESP);
  ...
  List_Enumerated(Machine(Buffer))==(?);
  List_Defered(Machine(Buffer))==(?);
  List_Sets(Machine(Buffer))==(?)
END
&
...
THEORY ListPropertiesX IS
  ...
  Context_List_Properties(Machine(Buffer))==(RESP: FIN(INTEGER) & not(RESP = {}));
  Inherited_List_Properties(Machine(Buffer))==(btrue);
  List_Properties(Machine(Buffer))==(btrue)
END
&
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Machine(Buffer),Machine(Resp))==(?);
  Seen_Context_List_Enumerated(Machine(Buffer))==(?);
  Seen_Context_List_Invariant(Machine(Buffer))==(btrue);
  Seen_Context_List_Assertions(Machine(Buffer))==(btrue);
  Seen_Context_List_Properties(Machine(Buffer))==(btrue);
  Seen_List_Constraints(Machine(Buffer))==(btrue);
  Seen_List_Operations(Machine(Buffer),Machine(Resp))==(?);
  Seen_Expanded_List_Invariant(Machine(Buffer),Machine(Resp))==(btrue)
END
&
