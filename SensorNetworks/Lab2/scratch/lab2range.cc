	...
	for (int d = 0; d < 10; d++) //Do this for 10 different distance values starting at 180 m with a 0.10 m increment in each iteration
        {
  		...
  		YansWifiChannelHelper wifiChannel;
                ...
                std::string lossModel = "ns3::RangePropagationLossModel";//define the name of the propagation loss model
                //This is the list of attributes used by the propagation loss model used.
                std::string atr1 = "MaxRange"; //Set up exponent value of the path loss propagation model
  		...
  		wifiChannel.AddPropagationLoss (lossModel, atr1, DoubleValue(180.5));
